...
```sh
git clone https://github.com/<your username>/opc-ua-vmd-events-acap.git
```

Navigate into the cloned directory and create a new branch:

```sh
cd opc-ua-vmd-events-acap
...
Run the following command in a terminal to lint the codebase locally:
...
[issues]: https://github.com/AxisCommunications/opc-ua-vmd-events-acap/issues
[issues_new]: https://github.com/AxisCommunications/opc-ua-vmd-events-acap/issues/new
[issues_bugs]: https://github.com/AxisCommunications/opc-ua-vmd-events-acap/issues?q=label%3Abug
[discussions]: https://github.com/AxisCommunications/opc-ua-vmd-events-acap/discussions
[discussions_new]: https://github.com/AxisCommunications/opc-ua-vmd-events-acap/discussions/new
